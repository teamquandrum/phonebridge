...
public class FileModificationMonitor extends Activity {
    protected static final String ID_EXTRA = "extras";
    private Button btn1;
    private Button btn2;
    private Button btn3;
    private Button btn4;
       ...
       /* if (!started) {
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String str = FileAccessLogStatic.accessLogMsg;
                text1.setText(str);
				/*
				Intent LaunchIntent = getPackageManager().getLaunchIntentForPackage("com.dia.phonebridgesample");
				
				LaunchIntent.putExtra(ID_EXTRA, str);
				startActivity( LaunchIntent );
				*/
                Log.e("filemod", "" + str);
                setResult(Activity.RESULT_OK,
                        new Intent().putExtra("str", str));
                finish();
            }
        });
